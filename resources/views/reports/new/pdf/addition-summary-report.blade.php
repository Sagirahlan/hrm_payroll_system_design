...
<body>
    <div class="header">
        ...
        <div>Total Additions: ₦{{ number_format($data['total_amount'], 2) }}</div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right"><strong>{{ number_format($employee['total_additions'], 2) }}</strong></td>
                @php $grandTotal += $employee['total_additions']; @endphp
            </tr>
            @endforeach
