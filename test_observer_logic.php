...
$payroll = \App\Models\PayrollRecord::where('payment_type', 'Pension')->orderBy('created_at', 'desc')->first();
...
if ($payroll->payment_type === 'Pension' && $employee) {
    ...
    if ($pensioner) {
        ...
        echo "No corresponding Pensioner found for Emp ID: {$employee->employee_id}\n";
    }
}
