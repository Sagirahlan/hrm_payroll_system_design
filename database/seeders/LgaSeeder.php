...
class LgaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $lgas = [
            ...
            'Ekiti' => ['Ado-Ekiti', 'Aiyekire (Gbonyin)', 'Efon', 'Ekiti East', 'Ekiti South-West', 'Ekiti West', 'Emure', 'Ido-Osi', 'Ijero', 'Ikere', 'Ikole', 'Ilejemeje', 'Irepodun/Ifelodun', 'Ise/Orun', 'Moba', 'Oye'],
        ...
        foreach ($lgas as $stateName => $stateLgas) {
