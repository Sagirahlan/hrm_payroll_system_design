...
class NigerianStatesLgasWardsSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // Nigeria's 36 states and 1 FCT with their LGAs
        $statesAndLgas = [
            [
                'state' => 'Abia',
                'lgas' => [
                    ...
                    'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umuneochi'
                ]
            ],
            [
                'state' => 'Adamawa',
                'lgas' => [
                    'Demsa', 'Fufure', 'Ganye', 'Gayuk', 'Gombi', 'Guyuk', 'Hong', 'Jada', 'Lamurde', 
                    'Madagali', 'Maiha', 'Mayo Belwa', 'Michika', 'Mubi North', 'Mubi South', 'Numan', 'Shelleng', 'Song', 'Toungo', 'Yola North', 'Yola South'
                ]
            ],
            [
                'state' => 'Akwa Ibom',
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Konshisha', 'Kwande', 'Logo', 'Makurdi', 'Obi', 'Ogbadibo', 'Ohimini', 'Oju', 'Okpokwu', 'Otukpo', 'Tarka', 'Ukum', 'Ushongo', 'Vandeikya'
                ]
            ],
            [
                'state' => 'Borno',
            ...
            [
                'state' => 'Cross River',
                'lgas' => [
                    'Abi', 'Akamkpa', 'Akpabuyo', 'Bekwarra', 'Biase', 'Boki', 'Calabar Municipal', 
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Nkwerre', 'Nwangele', 'Obowo', 'Oguta', 'Ohaji/Egbema', 'Okigwe', 'Orlu', 'Orsu', 'Oru East', 'Oru West', 'Owerri Municipal', 'Owerri North', 'Owerri West', 'Unuimo'
                ]
            ],
            [
                'state' => 'Jigawa',
                'lgas' => [
                    ...
                    'Guri', 'Gwaram', 'Hadejia', 'Jahun', 'Kafin Hausa', 'Kazaure', 'Kiri Kasama', 'Kiyawa', 
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Kura', 'Madobi', 'Makoda', 'Minjibir', 'Nassarawa', 'Rano', 'Rimin Gado', 'Rogo', 'Shanono', 
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Fakai', 'Gwandu', 'Jega', 'Kalgo', 'Koko/Besse', 'Maiyama', 'Ngaski', 'Sakaba', 'Shanga', 'Suru', 'Wasagu/Danko', 'Yauri', 'Zuru'
                ]
            ],
            [
                'state' => 'Kogi',
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Kontagora', 'Lapai', 'Lavun', 'Magama', 'Mariga', 'Mashegu', 'Mokwa', 'Moya', 'Paikoro', 
            ...
            [
                'state' => 'Osun',
                'lgas' => [
                    'Atakunmosa East', 'Atakunmosa West', 'Aiyedaade', 'Aiyedire', 'Boluwaduro', 'Boripe', 'Ede North', 
                    'Ede South', 'Egbedore', 'Ejigbo', 'Ife Central', 'Ife East', 'Ife North', 'Ife South', 
            ...
            [
                'state' => 'Oyo',
                'lgas' => [
                    'Afijio', 'Akinyele', 'Atiba', 'Atisbo', 'Egbada', 'Ibadan North', 'Ibadan North-East', 
            ...
            [
                ...
                'lgas' => [
                    ...
                    'Langtang North', 'Langtang South', 'Mangu', 'Mikang', 'Pankshin', 'Qua\'an Pan', 'Riyom', 'Shendam', 'Wase'
                ]
            ],
            [
                'state' => 'Rivers',
            ...
            [
                'state' => 'Taraba',
                'lgas' => [
                    'Ardo Kola', 'Bali', 'Donga', 'Gashaka', 'Gassol', 'Ibi', 'Jalingo', 'Karim Lamido', 'Kumi', 
        ...
        foreach ($statesAndLgas as $stateData) {
            // Insert state
            ...
            foreach ($stateData['lgas'] as $lgaName) {
                ...
                // Insert sample wards for this LGA (3-5 wards per LGA)
                $wardCount = rand(3, 5);
                for ($i = 1; $i <= $wardCount; $i++) {
                    DB::table('wards')->insert([
                        'ward_name' => $lgaName . ' Ward ' . $i,
                        'lga_id' => $lgaId,
                        'created_at' => now(),
                        'updated_at' => now()
                    ]);
        ...
        echo "Seeded all Nigerian states, LGAs, and sample wards successfully.\n";
    }
}