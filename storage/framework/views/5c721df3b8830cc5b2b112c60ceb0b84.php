...
<div class="container">
    <div class="mb-3">
        <a href="<?php echo e(route('loans.index')); ?>" class="btn btn-secondary">
                    ...
                    <form action="<?php echo e(route('loans.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="employee_id" id="employee_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $filteredEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?php $__errorArgs = ['deduction_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="principal_amount" id="principal_amount" class="form-control" value="<?php echo e(old('principal_amount')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" name="monthly_deduction" id="monthly_deduction" class="form-control" value="<?php echo e(old('monthly_deduction')); ?>">
                                <small class="form-text text-muted">OR percentage below</small>
                                <?php $__errorArgs = ['monthly_deduction'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="loan_duration_months" id="loan_duration_months" class="form-control" value="<?php echo e(old('loan_duration_months')); ?>" min="1">
                                <small class="form-text text-muted">Enter exact months (e.g., 29)</small>
                                <?php $__errorArgs = ['loan_duration_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/loans/create.blade.php ENDPATH**/ ?>