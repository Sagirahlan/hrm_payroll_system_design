...
<body>
    <div class="page-container">
        ...
        <div class="summary">
            <strong>Total Employees:</strong> <?php echo e($data['total_employees']); ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center"><?php echo e($employee['grade_level']); ?></td>
                    <td class="center"><?php echo e($employee['step']); ?></td>
                    <td class="center"><?php echo e($employee['status']); ?></td>
                    <td class="center"><?php echo e($employee['appointment_type']); ?></td>
                    <td class="center"><?php echo e($employee['years_of_service']); ?></td>
                    <td class="currency">₦<?php echo e(number_format($employee['basic_salary'], 2)); ?></td>
                    <td style="font-size: 8pt;"><?php echo e($employee['email']); ?></td>
                    <td style="font-size: 8pt;"><?php echo e($employee['mobile_no']); ?></td>
                </tr>
        ...
        <div class="footer">
            Katsina State Water Board - HR & Payroll Management System | Confidential Document
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/reports/new/pdf/employee-master-report.blade.php ENDPATH**/ ?>