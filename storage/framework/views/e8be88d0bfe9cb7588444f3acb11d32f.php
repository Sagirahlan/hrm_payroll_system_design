    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('leaves.store.my')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="employee_id" value="<?php echo e(auth()->user()->employee->employee_id ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="<?php echo e(route('leaves.my')); ?>" class="btn btn-secondary ms-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/leaves/create-my-leave.blade.php ENDPATH**/ ?>