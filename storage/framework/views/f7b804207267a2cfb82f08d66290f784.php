...
<div class="container">
    <div class="mb-3">
        <a href="<?php echo e(route('deduction-types.index')); ?>" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Back to Deduction Types
        </a>
    </div>
    
    <h1>Create Deduction Type</h1>
    <form action="<?php echo e(route('deduction-types.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/deduction-types/create.blade.php ENDPATH**/ ?>