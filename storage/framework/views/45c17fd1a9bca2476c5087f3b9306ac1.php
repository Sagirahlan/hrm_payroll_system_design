...
<body>
    ...
    <div class="summary">
        <p><strong>Total Loans:</strong> <?php echo e($data['total_loans']); ?></p>
        <p><strong>Total Principal:</strong> ₦<?php echo e(number_format($data['total_principal'], 2)); ?></p>
        <p><strong>Total Repaid:</strong> ₦<?php echo e(number_format($data['total_repaid'], 2)); ?></p>
        <p><strong>Total Remaining:</strong> ₦<?php echo e(number_format($data['total_remaining'], 2)); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($loan['employee_id']); ?></td>
                <td><?php echo e($loan['employee_name']); ?></td>
...
</html><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/reports/new/pdf/loan-status-report.blade.php ENDPATH**/ ?>