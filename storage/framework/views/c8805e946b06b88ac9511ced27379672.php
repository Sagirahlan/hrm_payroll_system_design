...
<body>
    <div class="page">
        <div class="header">
            ...
            <div class="report-title"><?php echo e($data['report_title'] ?? 'Retirement Planning Report'); ?></div>
            <div class="generated-date">Generated on: <?php echo e(now()->format('F j, Y g:i A')); ?></div>
        </div>

        <div class="summary">
            <p><strong>Total Approaching Retirement:</strong> <?php echo e($data['total_approaching_retirement']); ?></p>
            <p><strong>Period:</strong> <?php echo e($data['retirement_period_label'] ?? 'N/A'); ?></p>
        </div>
        ...
        <div class="content">
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $data['employees_approaching_retirement']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($employee['employee_id']); ?></td>
                        <td><?php echo e($employee['full_name']); ?></td>
                        <td><?php echo e($employee['calculated_retirement_date'] ?? $employee['expected_retirement_date']); ?></td>
                        <td><?php echo e($employee['expected_retirement_date']); ?></td>
                        <td><?php echo e(number_format($employee['years_of_service'], 1) ?? '0'); ?> years</td>
                        <td><?php echo e($employee['age']); ?></td>
                        <td><?php echo e($employee['retirement_reason'] ?? 'N/A'); ?></td>
                        <td><?php echo e($employee['months_to_retirement']); ?></td>
                    </tr>
        ...
        <div class="footer">
            ...
            Retirement Planning Report | Generated on <?php echo e(now()->format('F j, Y g:i A')); ?>.
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/reports/new/pdf/retirement-planning-report.blade.php ENDPATH**/ ?>