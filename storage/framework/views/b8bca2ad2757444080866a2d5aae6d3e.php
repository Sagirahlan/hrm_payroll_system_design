    ...
    <div class="modal fade" id="generateReportModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="generateReportForm" method="POST" action="<?php echo e(route('reports.comprehensive.generate')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = data.redirect || "<?php echo e(route('reports.comprehensive.index')); ?>";
            } else {
                // Show error message
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="loan_deduction_type_filter" name="filters[loan_type]">
                                ...
                                <?php $__currentLoopData = $loanDeductionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type->id); ?>"><?php echo e($type->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/reports/new/index.blade.php ENDPATH**/ ?>