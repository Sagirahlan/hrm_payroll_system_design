...
<body>
    ...
    <div class="summary">
        <p><strong>Total Departments:</strong> <?php echo e($data['total_departments']); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $data['departments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($dept['department_name']); ?></td>
                <td><?php echo e($dept['total_employees']); ?></td>
                <td><?php echo e($dept['active_employees']); ?></td>
                <td><?php echo e($dept['suspended_employees']); ?></td>
                <td><?php echo e($dept['retired_employees']); ?></td>
                <td><?php echo e($dept['deceased_employees']); ?></td>
                <td>₦<?php echo e(number_format($dept['total_basic_salary'], 2)); ?></td>
                <td>₦<?php echo e(number_format($dept['total_contract_amount'], 2)); ?></td>
                <td><?php echo e(number_format($dept['average_years_of_service'], 1)); ?></td>
            </tr>
    ...
    <div class="footer">
        Katsina State Water Board - HR & Payroll Management System | Generated on <?php echo e(now()->format('F j, Y g:i A')); ?>

    </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/reports/new/pdf/department-summary-report.blade.php ENDPATH**/ ?>