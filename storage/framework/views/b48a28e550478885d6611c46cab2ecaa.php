...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo e(number_format($getDeduction(['PAYE', 'Tax']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['NHF']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['NHIS', 'Health']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Union', 'Dues']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Rent']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Staff', 'Personal Loan']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Refurb']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Special']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['NHF Ren', 'Housing Loan']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($getDeduction(['Second']), 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($record['total_deductions'] ?? 0, 2)); ?></td>
                ...
                <tr class="bank-total">
                    ...
                    <td colspan="10"></td>
                    <td class="text-right"><?php echo e(number_format($bankTotal['deductions'], 2)); ?></td>
    ...
    <table>
        <tr class="grand-total">
            ...
            <td colspan="10"></td>
            <td class="text-right"><strong><?php echo e(number_format($grandTotal['deductions'], 2)); ?></strong></td>
