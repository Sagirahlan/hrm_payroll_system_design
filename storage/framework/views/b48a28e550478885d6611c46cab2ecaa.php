...
<body>
    ...
    <div class="summary">
        ...
        <p><strong>Total Records:</strong> <?php echo e($data['total_records']); ?></p>
        <p><strong>Total Basic Salary:</strong> ₦<?php echo e(number_format($data['total_basic_salary'], 2)); ?></p>
        <p><strong>Total Deductions:</strong> ₦<?php echo e(number_format($data['total_deductions'], 2)); ?></p>
        <p><strong>Total Additions:</strong> ₦<?php echo e(number_format($data['total_additions'], 2)); ?></p>
        <p><strong>Total Net Salary:</strong> ₦<?php echo e(number_format($data['total_net_salary'], 2)); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($record['grade_level']); ?></td>
                <td>₦<?php echo e(number_format($record['basic_salary'], 2)); ?></td>
                <td>₦<?php echo e(number_format($record['total_deductions'], 2)); ?></td>
                <td>₦<?php echo e(number_format($record['total_additions'], 2)); ?></td>
                <td>₦<?php echo e(number_format($record['net_salary'], 2)); ?></td>
