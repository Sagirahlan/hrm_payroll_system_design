        ...
        <div class="col-12">
            <div class="card border-0 shadow-lg rounded-lg">
                ...
                <div class="card-body px-3 px-md-5 py-4">
                    ...
                    <form id="employeeForm" action="<?php echo e(route('employees.update', $employee)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="step-card" id="step1">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" name="first_name" class="form-control" required value="<?php echo e(old('first_name', $employee->first_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" name="surname" class="form-control" required value="<?php echo e(old('surname', $employee->surname)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="date" name="date_of_birth" class="form-control" required value="<?php echo e(old('date_of_birth', $employee->date_of_birth)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="col-md-4 col-12">
                                    ...
                                    <select name="nationality" class="form-select" required>
                                        ...
                                        <option value="Nigeria" <?php echo e(old('nationality', $employee->nationality) == 'Nigeria' ? 'selected' : ''); ?>>Nigeria</option>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select id="state" name="state_id" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($state->state_id); ?>" <?php echo e(old('state_id', $employee->state_id) == $state->state_id ? 'selected' : ''); ?>><?php echo e($state->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" name="staff_no" class="form-control" required value="<?php echo e(old('staff_no', $employee->staff_no)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" name="nin" class="form-control" value="<?php echo e(old('nin', $employee->nin)); ?>">
                                    <?php $__errorArgs = ['nin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" name="mobile_no" class="form-control" required value="<?php echo e(old('mobile_no', $employee->mobile_no)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" name="pay_point" class="form-control" value="<?php echo e(old('pay_point', $employee->pay_point)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <textarea name="address" class="form-control" required><?php echo e(old('address', $employee->address)); ?></textarea>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <select id="appointment_type_id" name="appointment_type_id" class="form-select" required>
                                        <?php $__currentLoopData = $appointmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>" data-name="<?php echo e($type->name); ?>" <?php echo e(old('appointment_type_id', $employee->appointment_type_id) == $type->id ? 'selected' : ''); ?>><?php echo e($type->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="date" name="date_of_first_appointment" class="form-control" required value="<?php echo e(old('date_of_first_appointment', $employee->date_of_first_appointment)); ?>">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <select name="department_id" class="form-select">
                                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($department->department_id); ?>" <?php echo e(old('department_id', $employee->department_id) == $department->department_id ? 'selected' : ''); ?>><?php echo e($department->department_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <select name="cadre_id" class="form-select">
                                            <?php $__currentLoopData = $cadres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cadre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cadre->cadre_id); ?>" <?php echo e(old('cadre_id', $employee->cadre_id) == $cadre->cadre_id ? 'selected' : ''); ?>><?php echo e($cadre->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <select id="salary_scale_id" name="salary_scale_id_display" class="form-select" disabled>
                                            ...
                                            <?php $__currentLoopData = $salaryScales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($scale->id); ?>" <?php echo e(old('salary_scale_id', $employee->gradeLevel->salary_scale_id ?? '') == $scale->id ? 'selected' : ''); ?>><?php echo e($scale->acronym); ?> - <?php echo e($scale->full_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <input type="hidden" name="salary_scale_id" value="<?php echo e(old('salary_scale_id', $employee->gradeLevel->salary_scale_id ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <input type="hidden" id="grade_level_id" name="grade_level_id" value="<?php echo e(old('grade_level_id', $employee->grade_level_id)); ?>">
                                    <input type="hidden" id="step_id" name="step_id" value="<?php echo e(old('step_id', $employee->step_id)); ?>">
                                    <div class="col-md-6 col-12">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" name="expected_next_promotion" class="form-control" value="<?php echo e(old('expected_next_promotion', $employee->expected_next_promotion)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" name="expected_retirement_date" class="form-control" readonly value="<?php echo e(old('expected_retirement_date', $employee->expected_retirement_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row g-3 d-none" id="casual_appointment_fields">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" name="contract_start_date" class="form-control" value="<?php echo e(old('contract_start_date', $employee->contract_start_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" name="contract_end_date" class="form-control" value="<?php echo e(old('contract_end_date', $employee->contract_end_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="number" name="amount" class="form-control" value="<?php echo e(old('amount', $employee->amount)); ?>">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-12">
                                    ...
                                    <select name="status" class="form-select" required>
                                        ...
                                        <option value="Retired" <?php echo e(old('status', $employee->status) == 'Retired' ? 'selected' : ''); ?>>Retired</option>
                                        <option value="Retired-Active" <?php echo e(old('status', $employee->status) == 'Retired-Active' ? 'selected' : ''); ?>>Retired-Active</option>
                                        <option value="Deceased" <?php echo e(old('status', $employee->status) == 'Deceased' ? 'selected' : ''); ?>>Deceased</option>
                                        <option value="Hold" <?php echo e(old('status', $employee->status) == 'Hold' ? 'selected' : ''); ?>>Hold</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select name="highest_certificate" class="form-control">
                                        ...
                                        <option value="No formal education" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'No formal education' ? 'selected' : ''); ?>>No formal education</option>
                                        <option value="Primary education" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Primary education' ? 'selected' : ''); ?>>Primary education</option>
                                        <option value="Secondary education / High school or equivalent" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Secondary education / High school or equivalent' ? 'selected' : ''); ?>>Secondary education / High school or equivalent (e.g. SSCE, WAEC, NECO)</option>
                                        <option value="Vocational qualification" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Vocational qualification' ? 'selected' : ''); ?>>Vocational qualification (e.g. NABTEB, trade certificates, NVC)</option>
                                        <option value="Associate degree / NCE / ND" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Associate degree / NCE / ND' ? 'selected' : ''); ?>>Associate degree / NCE / National Diploma (ND)</option>
                                        <option value="Bachelor’s degree" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Bachelor’s degree' ? 'selected' : ''); ?>>Bachelor’s degree (B.Sc, B.A, B.Eng, LLB, etc.)</option>
                                        <option value="Professional degree/license" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Professional degree/license' ? 'selected' : ''); ?>>Professional degree/license (e.g., BL, ICAN, COREN, TRCN, MDCN)</option>
                                        <option value="Master’s degree" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Master’s degree' ? 'selected' : ''); ?>>Master’s degree (M.Sc, MBA, M.A, etc.)</option>
                                        <option value="Doctorate / Ph.D. or higher" <?php echo e(old('highest_certificate', $employee->highest_certificate) == 'Doctorate / Ph.D. or higher' ? 'selected' : ''); ?>>Doctorate / Ph.D. or higher</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <?php if($employee->photo_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $employee->photo_path)); ?>" alt="Employee Photo" width="100" class="mt-2 rounded border">
                                    <?php endif; ?>
                        ...
                        <div class="step-card d-none" id="step5">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" name="kin_name" class="form-control" required value="<?php echo e(old('kin_name', $employee->nextOfKin->name ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" name="kin_relationship" class="form-control" required value="<?php echo e(old('kin_relationship', $employee->nextOfKin->relationship ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="form-label font-weight-bold">Mobile No <span class="text-danger">*</span></label>
                                    <input type="text" name="kin_mobile_no" class="form-control" required value="<?php echo e(old('kin_mobile_no', $employee->nextOfKin->mobile_no ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="form-label font-weight-bold">Address <span class="text-danger">*</span></label>
                                    <input type="text" name="kin_address" class="form-control" required value="<?php echo e(old('kin_address', $employee->nextOfKin->address ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" name="kin_occupation" class="form-control" value="<?php echo e(old('kin_occupation', $employee->nextOfKin->occupation ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" name="kin_place_of_work" class="form-control" value="<?php echo e(old('kin_place_of_work', $employee->nextOfKin->place_of_work ?? '')); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldStateId = "<?php echo e(old('state_id', $employee->state_id)); ?>";
        const oldLgaId = "<?php echo e(old('lga_id', $employee->lga_id)); ?>";
        const oldWardId = "<?php echo e(old('ward_id', $employee->ward_id)); ?>";
                ...
                fetch(`/api/salary-scales/${salaryScaleId}/grade-levels`)
                    ...
                    .then(data => {
                        ...
                        if (data.length > 0) {
                            ...
                            const oldGradeLevelName = "<?php echo e(old('grade_level_name', $employee->gradeLevel->name ?? '')); ?>";
                ...
                fetch(`/api/salary-scales/${salaryScaleId}/grade-levels/${selectedGradeLevelName}/steps`)
                    ...
                    .then(steps => {
                        ...
                        if (steps.length > 0) {
                            ...
                            const oldStepLevel = "<?php echo e(old('step_level', $employee->step->name ?? '')); ?>";
                            if (oldStepLevel) {
        ...
        const oldSalaryScaleId = "<?php echo e(old('salary_scale_id', $employee->gradeLevel->salary_scale_id ?? '')); ?>";
        if (oldSalaryScaleId) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/employees/edit.blade.php ENDPATH**/ ?>