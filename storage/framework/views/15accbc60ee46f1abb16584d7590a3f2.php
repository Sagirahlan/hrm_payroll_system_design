...
<body>
    ...
    <div class="summary">
        <p><strong>Total Deductions:</strong> <?php echo e($data['total_deductions']); ?></p>
        <p><strong>Total Amount:</strong> ₦<?php echo e(number_format($data['total_amount'], 2)); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($deduction['employee_id']); ?></td>
                <td><?php echo e($deduction['employee_name']); ?></td>
                <td><?php echo e($deduction['department']); ?></td>
                <td><?php echo e($deduction['deduction_type']); ?></td>
                <td>₦<?php echo e(number_format($deduction['amount'], 2)); ?></td>
                <td><?php echo e($deduction['start_date']); ?></td>
                <td><?php echo e($deduction['end_date']); ?></td>
                <td><?php echo e($deduction['frequency']); ?></td>
            </tr>
