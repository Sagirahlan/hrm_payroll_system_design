<?php $__env->startSection('title', 'Bulk Deductions'); ?>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <?php $__currentLoopData = $statutoryDeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="deduction_types[]" value="<?php echo e($type->id); ?>" id="deduction_<?php echo e($type->id); ?>">
                                    <label class="form-check-label" for="deduction_<?php echo e($type->id); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type_id" id="type_id" class="form-select">
                                ...
                                <?php $__currentLoopData = $nonStatutoryDeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('payroll.deductions')); ?>" method="GET" id="employee-filter-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <a href="<?php echo e(route('payroll.deductions')); ?>" class="btn btn-outline-danger" title="Clear Search">Clear</a>
                        </div>
    ...
    <div class="col-md-4">
        ...
        <select name="department_id" id="department_filter" class="form-select">
            ...
            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($department->department_id); ?>" <?php echo e(request('department_id') == $department->department_id ? 'selected' : ''); ?>><?php echo e($department->department_name); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="col-md-4">
        ...
        <select name="grade_level_id" id="grade_level_filter" class="form-select">
            ...
            <?php $__currentLoopData = $gradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gradeLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($gradeLevel->id); ?>" <?php echo e(request('grade_level_id') == $gradeLevel->id ? 'selected' : ''); ?>><?php echo e($gradeLevel->name); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/payroll/deductions.blade.php ENDPATH**/ ?>