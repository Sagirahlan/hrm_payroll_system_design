...
<div class="container">
    <h2>Edit Role: <?php echo e($role->role_name); ?></h2>
                        ...
                        <div class="col-md-6 col-lg-4 mb-2 permission-item" data-permission="<?php echo e(strtolower($name)); ?>">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="<?php echo e($id); ?>" id="permission_<?php echo e($id); ?>"
                                       <?php echo e(in_array($id, $rolePermissions) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rowwww\Herd\hrm_payroll_system_design\resources\views/roles/edit.blade.php ENDPATH**/ ?>